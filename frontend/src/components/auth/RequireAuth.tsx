 ...
 * 로그인이 필요한 라우트 묶음의 부모.
 *
 * 로그인 요구를 전부 모달로 통일한 안이다. 액션(좋아요·팔로우·글쓰기)은 이미
 * 제자리에서 안내 모달을 띄우고 있었고, 로그인 필요 페이지만 /login 화면으로
 * 튕겨 냈다. 어느 쪽이 나은지 비교하려고 갈래를 하나로 모은다.
 * (페이지 이동으로 통일한 짝은 FE/test/login-page 브랜치다.)
 *
