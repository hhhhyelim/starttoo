...
export default function EditPostModal({
	...
	return createPortal(
		<div
			className="fixed inset-0 z-[120] flex items-center justify-center bg-black/70 p-6 max-lg:bg-surface max-lg:p-0"
			onClick={handleClose}
			role="presentation">
			<div
				...
				<div className="relative flex h-[52px] items-center justify-center border-b border-black/10 px-4">
					<p className="text-[15px] font-semibold text-black">게시물 수정</p>
					<button
						type="button"
						aria-label="닫기"
						onClick={handleClose}
